    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'image' => 'post-cover/pexels-markusspiske-6502328.jpg',
                'views' => 150,
            ...
            [
                ...
                'image' => 'post-cover/pexels-pixabay-60504.jpg',
                'views' => 120,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[1]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-ferarcosn-211151.jpg',
                'views' => 180,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[1]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-tima-miroshnichenko-5380610.jpg',
                'views' => 160,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[1]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-kevin-ku-92347-577585.jpg',
                'views' => 150,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[1]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-alessandro-oliverio-611273-1472443.jpg',
                'views' => 140,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-shkrabaanthony-5475752.jpg',
                'views' => 170,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/pexels-brett-sayles-3803517.jpg',
                'views' => 130,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/quantum-computing.jpg',
                'views' => 190,
                'category_id' => $cyberSecurityCategory->id,
                'author' => $author[2]->id,
            ],
