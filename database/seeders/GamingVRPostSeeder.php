    ...
    public function run(): void
    {
        ...
        $posts = [
            [
                ...
                'image' => 'post-cover/ai-generated-8630221_1280.jpg',
                'views' => 170,
            ...
            [
                ...
                'image' => 'post-cover/ai-generated-9214144_1280.jpg',
                'views' => 190,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/virtual-7432926_1280.jpg',
                'views' => 200,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/ai-generated-8915803_1280.jpg',
                'views' => 180,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/virtual-reality-4995294_1280.jpg',
                'views' => 170,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[2]->id,
            ],
            [
                ...
                'image' => 'post-cover/girl-6354292_1280.png',
                'views' => 160,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[1]->id,
            ],
            [
                ...
                'image' => 'post-cover/ai-generated-8055453_1280.jpg',
                'views' => 150,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[1]->id,
            ],
            ...
            [
                ...
                'image' => 'post-cover/potion-2217630_1280.jpg',
                'views' => 130,
                'category_id' => $gamingVRCategory->id,
                'author' => $author[1]->id,
            ],
